      ...
      <Grid>
        <GridCol className='col-12 col-sm-8'>
          ...
          <section className='section'>
            <Svg url='/ui/svg/eye.svg' className='float-right'/>
          ...
          <section className='section'>
            <Svg url='/ui/svg/take.svg' className='float-right'/>
          ...
          <section className='section'>
            <Svg url='/ui/svg/effects.svg' className='float-right'/>
          ...
          <section className='section'>
            <Svg url='/ui/svg/risks.svg' className='float-right'/>
          ...
          <section className='section'>
            <Svg url='/ui/svg/law.svg' className='float-right'/>
