...
const Typography = props => {
  return (
    <main>
      <div className='container container-fluid spacing--large'>
      ...
      <Accent className='accent--dark'>
          ...
          <div className='long-form'><p className='lead'>Lead text - used to introduce a section of long-form content</p></div>
          <hr className='divider mt-5 mb-5'/>
          <div className='long-form'><h3>This is standard body copy</h3><p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?</p></div>
          <hr className='divider mt-5 mb-5'/>
          <div className='long-form'><small>A section of small text. Infrequently used - perhaps for captions only?</small></div>
          <hr className='divider mt-5 mb-5'/>
          <h3 className='spacing-bottom--single'>The following are calls-to-action</h3>
